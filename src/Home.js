...
//   alert("seting state",this.state.url);
}
	...
	join = () => {
		if (this.state.url !== "") {
           ...
           // console.log("state is ",this.state.url);
			//console.log("joining meeting",url[url.length-1]);
		} else {
		...
		return (
			<div className="container2">
				...
				<div style={{
					...
					<Button variant="contained" color="primary" onClick={this.join} style={{ margin: "20px" }}>Create Room</Button>
				</div>
			</div>
		)
	}
